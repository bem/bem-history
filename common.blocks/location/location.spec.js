...
describe('location native API', function() {
        ...
        it('should change location by path and emit history event statechange', function() {
            ...
            (u.path() + u.query()).should.be.eql('/desktop.specs/location/spec-js+browser-js+bemhtml/spec-js+browser-js+bemhtml.html?test=a&ololo=123');
        });
        ...
        it('should change location by params with forceParams flag and emit history event statechange', function() {
            ...
            var u = Uri.parse(window.location.href);
            (u.path() + u.query()).should.be.eql('/desktop.specs/location/spec-js+browser-js+bemhtml/spec-js+browser-js+bemhtml.html?test=1&test=2');
        });
        ...
        it('should change location by params without forceParams flag and emit history event statechange', function() {
            ...
            var u = Uri.parse(window.location.href);
            (u.path() + u.query()).should.be.eql('/desktop.specs/location/spec-js+browser-js+bemhtml/spec-js+browser-js+bemhtml.html?test=1&test=2&param2=22');
        });
